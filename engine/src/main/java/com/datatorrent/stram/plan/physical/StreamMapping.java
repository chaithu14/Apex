...
public class StreamMapping implements java.io.Serializable
{
  ...
  private List<PTOutput> setupPartitionerUnifiers(List<PTOutput> upstream, Partitioner<Operator> partitioner) {
    ...
    Collection<Partitioner.Partition<Operator>> collection = new ArrayList<Partitioner.Partition<Operator>>(1);
    ...
    List<PTOutput> Unifierupstream = new LinkedList<PTOutput>();
